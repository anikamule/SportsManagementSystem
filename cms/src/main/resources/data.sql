...
VALUES (1, 'John', 'Doe', 'john.doe@gmail.com', 'password123', 'captain'),
       ...
       (9, 'Noah', 'Martinez', 'noah.martinez@hotmail.com', 'goalkeeper99', 'captain'),
...
VALUES (56, 'Ethan', 'Clark', 'ref4@example.com', 'whistleBlow56!', 'referee'),
       (57, 'Ava', 'Henderson', 'ref5@example.com', 'fairPlay57$', 'referee'),
       (58, 'Noah', 'Ramirez', 'ref6@example.com', 'offsideCall58#', 'referee'),
       (59, 'Isabella', 'Foster', 'ref7@example.com', 'yellowCard59%', 'referee'),
       (60, 'Mason', 'Reynolds', 'ref8@example.com', 'redCard60&', 'referee'),
       (61, 'Sophie', 'Nguyen', 'ref9@example.com', 'VARcheck61*', 'referee'),
       (62, 'Alexander', 'Patel', 'ref10@example.com', 'fairRef62!', 'referee'),
       (63, 'Emily', 'Scott', 'ref11@example.com', 'extraTime63$', 'referee'),
       (64, 'William', 'King', 'ref12@example.com', 'penaltyCall64#', 'referee'),
       (65, 'Madison', 'Barnes', 'ref13@example.com', 'handBall65%', 'referee'),
       (66, 'James', 'Bennett', 'ref14@example.com', 'goalCheck66&', 'referee'),
       (67, 'Chloe', 'Rodriguez', 'ref15@example.com', 'clearFoul67*', 'referee'),
       (68, 'Logan', 'White', 'ref16@example.com', 'gameStart68!', 'referee'),
       (69, 'Natalie', 'Hill', 'ref17@example.com', 'finalWhistle69$', 'referee'),
       (70, 'Daniel', 'Perez', 'ref18@example.com', 'matchControl70#', 'referee');
...
(12, '2025-04-10 15:00:00', 'Athletic Centre', 'T005', 'T015', 0, 0, 'upcoming', 60, 'L001');